...
- Type `git clone https://github.com/tonnymuchui/Awesome-books` if your're using https with git or `git clone git@github.com/tonnymuchui/Awesome-books` if your preferred is ssh and hit enter.
